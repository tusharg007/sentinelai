...
class TestImaging:
    ...
    def test_make_strip_width(self):
        from app.core.imaging import make_strip
        a = make_rgb(200, 300)
        b = make_rgb(200, 300)
...
class TestFusion:
    def test_simulate_ir_shape(self):
        from app.services.fusion import simulate_ir
        rgb = make_rgb()
        ir = simulate_ir(rgb)
        assert ir.shape == rgb.shape

    def test_simulate_sar_shape(self):
        from app.services.fusion import simulate_sar
        rgb = make_rgb()
...
class TestGeospatial:
    def test_center_pixel_maps_to_center_coord(self):
        from app.services.geospatial import pixel_to_wgs84
    ...
    def test_footprint_calculation(self):
        from app.services.geospatial import bbox_footprint_m2
...
class TestChangeDetection:
    ...
    def test_find_regions_structure(self):
        from app.services.change import _find_regions
...
class TestConfig:
    ...
    def test_taxonomy_structure(self):
        from app.core.config import ASSET_TAXONOMY
    ...
    def test_all_mission_keys(self):
        from app.core.config import MISSION_MULTIPLIERS
